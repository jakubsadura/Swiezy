/*=========================================================================
  ...
  Module:    $RCSfile: blvtkFinitCylinder.h,v $
...
#ifndef __blvtkFinitCylinder_h
#define __blvtkFinitCylinder_h

#include "vtkImplicitFunction.h"
#include "BaseLibVTKWin32Header.h"

class BASELIBVTK_EXPORT blvtkFinitCylinder : public vtkImplicitFunction
{
public:
  // Description
  // Construct plane passing through origin and normal to z-axis.
  static blvtkFinitCylinder *New();

  vtkTypeRevisionMacro(blvtkFinitCylinder,vtkImplicitFunction);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description
  // Evaluate cylinder equation for point x[3].
...
private:
  blvtkFinitCylinder(const blvtkFinitCylinder&);  // Not implemented.
  void operator=(const blvtkFinitCylinder&);  // Not implemented.
};

inline double blvtkFinitCylinder::Evaluate(double normal[3], 
...
inline double blvtkFinitCylinder::DistanceToPlane(double x[3], double n[3], double p0[3])
{
