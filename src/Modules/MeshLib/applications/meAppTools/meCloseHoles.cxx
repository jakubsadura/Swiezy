/*=========================================================================
 ...
 Module    : $RCSfile: meCloseHoles.cxx,v $
 Authors   : Jose M. Pozo 
 Copyright : Pompeu Fabra University, 2008
 Purpose   : Demo for closing holes in a vtkPolyData mesh using 
 the class meCloseHoles, able to apply different algorithms.
...
void usage()
{
	cerr << "Usage: meCloseHoles [input] [output] <option>" 				<< endl;
	cerr << "The input/output are vtkPolyData meshes of triangles" 			<< endl;
	cerr << "Options:" 								<< endl;
	cerr << " -v, --verbose    Details of the read/writen file proporties" 		<< endl;
...
int main(int argc, char *argv[])
{
	...
	//	geomeHoleFiller::Pointer meshcloser = geomeHoleFiller::New();
	//	vtkFillHolesFilter * meshcloser = vtkFillHolesFilter::New();
