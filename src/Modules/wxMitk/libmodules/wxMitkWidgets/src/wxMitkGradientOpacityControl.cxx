...
BEGIN_EVENT_TABLE(wxMitkGradientOpacityControl, wxControl)
    EVT_PAINT				(wxMitkGradientOpacityControl::OnPaint)
	EVT_MOUSE_EVENTS		(wxMitkGradientOpacityControl::OnMouseEvent)
	EVT_MOUSE_CAPTURE_LOST	(wxMitkGradientOpacityControl::OnMouseCaptureLost)
	EVT_ERASE_BACKGROUND	(wxMitkGradientOpacityControl::OnEraseBackground)
END_EVENT_TABLE()



wxMitkGradientOpacityControl::wxMitkGradientOpacityControl(wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxValidator& validator, const wxString& name)
...
wxMitkGradientOpacityControl::~wxMitkGradientOpacityControl(void)
{
}
...
*/
void wxMitkGradientOpacityControl::OnMouseEvent(wxMouseEvent& event)
{
...
//!
void wxMitkGradientOpacityControl::OnMouseCaptureLost(wxMouseCaptureLostEvent& event)
{
	//if(this->HasCapture())
	//	this->ReleaseMouse();
	//event.Skip();
...
//!
void wxMitkGradientOpacityControl::OnPaint(wxPaintEvent& WXUNUSED(event))
{
...
*/
void wxMitkGradientOpacityControl::OnEraseBackground(wxEraseEvent& event)
{
  	event.Skip(false);
}
...
//!
void wxMitkGradientOpacityControl::DrawControl(wxDC& Dc, bool foreGroundOnly)
{
...
//!
void wxMitkGradientOpacityControl::GetClientSize(int* width, int* height) const
{
	this->wxControl::GetClientSize(width, height);
}

//!
wxColour wxMitkGradientOpacityControl::GetBackgroundColour() const
{
...
*/
bool wxMitkGradientOpacityControl::MovingFunctionPointIsAllowed(double& fpX)
{
	int selectedHandle = this->GetSelectedHandle();
	if(this->GetPiecewiseFunction() == NULL)
		return false;
...
*/
void wxMitkGradientOpacityControl::UpdateObserversOfTransferFunction(void)
{
...
*/
void wxMitkGradientOpacityControl::UpdateObserversOfMousePosition(const double fpX, const double opacity)
{
...
*/
void wxMitkGradientOpacityControl::SetInteractiveApply(bool enable)
{
...
//!
bool wxMitkGradientOpacityControl::Enable(bool enable)
{
