...
class TPEXTLIBWXWIDGETS_EXPORT wxThumbnailItem: public wxObject
{
...
// Constructors
    ...
    { m_filename = filename; m_title = title; m_state = 0; }
...
class TPEXTLIBWXWIDGETS_EXPORT wxImageThumbnailItem: public wxThumbnailItem
{
...
// Constructors
    ...
    wxImageThumbnailItem(
		const wxString& filename = wxEmptyString, 
		const wxString& title = wxEmptyString ) : wxThumbnailItem(filename,title) {}
...
WX_DECLARE_USER_EXPORTED_OBJARRAY(wxThumbnailItem, wxThumbnailItemArray,TPEXTLIBWXWIDGETS_EXPORT);

/*!
 * wxThumbnailCtrl class declaration
 */

class TPEXTLIBWXWIDGETS_EXPORT wxThumbnailCtrl: public wxScrolledWindow
{    
...
BEGIN_DECLARE_EVENT_TYPES()
    DECLARE_EXPORTED_EVENT_TYPE(TPEXTLIBWXWIDGETS_EXPORT,wxEVT_COMMAND_THUMBNAIL_ITEM_SELECTED, 2600)
    DECLARE_EXPORTED_EVENT_TYPE(TPEXTLIBWXWIDGETS_EXPORT,wxEVT_COMMAND_THUMBNAIL_ITEM_DESELECTED, 2601)
    DECLARE_EXPORTED_EVENT_TYPE(TPEXTLIBWXWIDGETS_EXPORT,wxEVT_COMMAND_THUMBNAIL_LEFT_CLICK, 2602)
    DECLARE_EXPORTED_EVENT_TYPE(TPEXTLIBWXWIDGETS_EXPORT,wxEVT_COMMAND_THUMBNAIL_RIGHT_CLICK, 2603)
    DECLARE_EXPORTED_EVENT_TYPE(TPEXTLIBWXWIDGETS_EXPORT,wxEVT_COMMAND_THUMBNAIL_MIDDLE_CLICK, 2604)
    DECLARE_EXPORTED_EVENT_TYPE(TPEXTLIBWXWIDGETS_EXPORT,wxEVT_COMMAND_THUMBNAIL_LEFT_DCLICK, 2605)
    DECLARE_EXPORTED_EVENT_TYPE(TPEXTLIBWXWIDGETS_EXPORT,wxEVT_COMMAND_THUMBNAIL_RETURN, 2606)
END_DECLARE_EVENT_TYPES()

typedef void (wxEvtHandler::*wxThumbnailEventFunction)(wxThumbnailEvent&);

#define wxThumbnailEventHandler(func) \
