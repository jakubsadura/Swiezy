...
public:
  ...
  typedef itk::Statistics::ImageToListSampleAdaptor2< 
                                              ImageType 
                                                      >   AdaptorType;
  ...
  typedef itk::Statistics::Histogram2< double > HistogramType;
  typedef itk::Statistics::SampleToHistogramFilter2< AdaptorType, HistogramType > GeneratorType;
