/*=========================================================================
  ...
  Module:    $RCSfile: itkImageToListSampleAdaptor2.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkImageToListSampleAdaptor2_h
#define __itkImageToListSampleAdaptor2_h
...
/** \class ImageToListSampleAdaptor2
...
class ImageToListSampleAdaptor2 : 
    public ListSample2< typename MeasurementVectorPixelTraits2< typename TImage::PixelType >::MeasurementVectorType >
{
public:
  /** Standard class typedefs */
  typedef ImageToListSampleAdaptor2               Self;

  typedef ListSample2< typename MeasurementVectorPixelTraits2<
  ...
  itkTypeMacro(ImageToListSampleAdaptor2, ListSample2);
  ...
  typedef typename MeasurementVectorPixelTraits2<
  ...
  class ConstIterator
    {
    friend class ImageToListSampleAdaptor2;
    public:

    ConstIterator( const ImageToListSampleAdaptor2 * adaptor )
      {
      *this = adaptor->Begin();
      }
 ...
 /** \class ImageToListSampleAdaptor2::Iterator */
...
protected:
  ...
  virtual ~ImageToListSampleAdaptor2() {}
  void PrintSelf(std::ostream& os, Indent indent) const;  

private:
  ImageToListSampleAdaptor2(const Self&); //purposely not implemented
...
}; // end of class ImageToListSampleAdaptor2

} // end of namespace Statistics
} // end of namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkImageToListSampleAdaptor2.txx"
#endif
