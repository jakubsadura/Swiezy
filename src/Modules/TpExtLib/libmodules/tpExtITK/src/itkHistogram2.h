...
=========================================================================*/
#ifndef __itkHistogram2_h
#define __itkHistogram2_h
...
class Histogram2
  : public Sample2 < Array< TMeasurement > >
{
public:
  ...
  /** Standard typedefs */
  typedef Histogram2                    Self;
  typedef Sample2< ArrayType  >         Superclass;
  typedef SmartPointer<Self>           Pointer;
  typedef SmartPointer<const Self>     ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(Histogram2, Sample2);
...
private:
  Histogram2(const Self&); //purposely not implemented
