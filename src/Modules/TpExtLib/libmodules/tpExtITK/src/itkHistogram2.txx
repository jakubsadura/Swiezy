...
=========================================================================*/
#ifndef __itkHistogram2_txx
#define __itkHistogram2_txx
...
Histogram2<TMeasurement, TFrequencyContainer >
::Histogram2()
{
...
template< class TMeasurement, class TFrequencyContainer >
typename 
Histogram2<TMeasurement, TFrequencyContainer >::InstanceIdentifier
Histogram2<TMeasurement, TFrequencyContainer >
::Size() const
{
...
template< class TMeasurement, class TFrequencyContainer >
const typename 
Histogram2<TMeasurement, TFrequencyContainer >::SizeType &
Histogram2<TMeasurement, TFrequencyContainer >
::GetSize() const
{
  return m_Size;
...
template< class TMeasurement, class TFrequencyContainer >
typename 
Histogram2<TMeasurement, TFrequencyContainer >::SizeValueType
Histogram2<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
const typename 
Histogram2<TMeasurement, TFrequencyContainer >::MeasurementType &
Histogram2<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
const typename 
Histogram2<TMeasurement, TFrequencyContainer >::BinMinVectorType &
Histogram2<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
const typename 
Histogram2<TMeasurement, TFrequencyContainer >::BinMaxVectorType &
Histogram2<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
const typename 
Histogram2<TMeasurement, TFrequencyContainer >::BinMinContainerType &
Histogram2<TMeasurement, TFrequencyContainer >
::GetMins() const
{
  return m_Min;
...
template< class TMeasurement, class TFrequencyContainer >
const typename 
Histogram2<TMeasurement, TFrequencyContainer >::BinMaxContainerType &
Histogram2<TMeasurement, TFrequencyContainer >
::GetMaxs() const
{
  return m_Max;
...
template< class TMeasurement, class TFrequencyContainer >
typename 
Histogram2<TMeasurement, TFrequencyContainer >::AbsoluteFrequencyType
Histogram2<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
inline const typename Histogram2<TMeasurement, TFrequencyContainer >::IndexType &
Histogram2<TMeasurement, TFrequencyContainer >
...
/** */
template< class TMeasurement, class TFrequencyContainer >
bool Histogram2<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
inline typename Histogram2<TMeasurement, TFrequencyContainer >::InstanceIdentifier
Histogram2<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
inline const typename Histogram2<TMeasurement, TFrequencyContainer >::MeasurementType&
Histogram2<TMeasurement, TFrequencyContainer >
::GetBinMinFromValue(const unsigned int dimension, const float value ) const
{
  // If the value is lower than any of min value in the Histogram2,
  ...
  // If the value is higher than any of min value in the Histogram2,
...
{
  // If the value is lower than any of max value in the Histogram2,
  ...
  // If the value is higher than any of max value in the Histogram2,
...
template< class TMeasurement, class TFrequencyContainer >
const typename 
Histogram2< TMeasurement, TFrequencyContainer >::MeasurementVectorType&
Histogram2< TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
inline const typename Histogram2< TMeasurement, TFrequencyContainer >::MeasurementVectorType &
Histogram2< TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
inline typename Histogram2< TMeasurement, TFrequencyContainer >::AbsoluteFrequencyType
Histogram2< TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
inline typename Histogram2< TMeasurement, TFrequencyContainer >::TotalAbsoluteFrequencyType
Histogram2< TMeasurement, TFrequencyContainer >
