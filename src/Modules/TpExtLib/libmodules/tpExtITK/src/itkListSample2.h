/*=========================================================================
  ...
  Module:    $RCSfile: itkListSample2.h,v $
  Language:  C++
  Date:      $Date: 2009-05-22 12:55:02 $
...
=========================================================================*/
#ifndef __itkListSample2_h
#define __itkListSample2_h

#include "itkObjectFactory.h"
#include "itkFixedArray.h"
#include "itkSample2.h"
 ...
 *
 * ListSample2 stores measurements in a list type structure (as opposed to a
 * Histogram, etc.).  ListSample2 allows duplicate measurements. ListSample2 is
 * not sorted.
 *
 * ListSample2 does not allow the user to specify the frequency of
...
class ListSample2 : public Sample2< TMeasurementVector >
{
public:
  /** Standard class typedef. */
  typedef ListSample2                     Self;
  typedef Sample2< TMeasurementVector >   Superclass;
  typedef SmartPointer< Self >           Pointer;
  typedef SmartPointer<const Self>       ConstPointer;

  /** Standard macros */
  itkTypeMacro(ListSample2, Sample2);
  ...
  /** \class ListSample2::ConstIterator */
  class ConstIterator
    {
    friend class ListSample2;

    public:

    ConstIterator( const ListSample2 * sample )
      {
      *this = sample->Begin();
      }
  ...
  protected:
#endif
    // This method should only be available to the ListSample2 class
    ConstIterator(
...
private:
  ListSample2(const Self&); //purposely not implemented
