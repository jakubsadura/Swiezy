/*=========================================================================
  ...
  Module:    $RCSfile: itkSampleToHistogramFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkSampleToHistogramFilter2_h
#define __itkSampleToHistogramFilter2_h
...
class SampleToHistogramFilter2 : public ProcessObject
{
public:
  /** Standard class typedefs */
  typedef SampleToHistogramFilter2       Self;  
  typedef ProcessObject                 Superclass;
  typedef SmartPointer< Self >          Pointer;
  typedef SmartPointer<const Self >     ConstPointer;

  /** Run-time type information (and related methods) */
  itkTypeMacro(SampleToHistogramFilter2, ProcessObject);
...
protected:
  SampleToHistogramFilter2();
  virtual ~SampleToHistogramFilter2();
...
private:
  SampleToHistogramFilter2(const Self&); //purposely not implemented
...
#include "itkSampleToHistogramFilter2.txx"
#endif
