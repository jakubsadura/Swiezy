...
#include "itkSampleToHistogramFilter2.h"
#include "itkStatisticsAlgorithm2.h"

namespace itk { 
namespace Statistics {

template < class TSample, class THistogram >
SampleToHistogramFilter2< TSample, THistogram >
...
template < class TSample, class THistogram >
const typename 
SampleToHistogramFilter2< TSample, THistogram >::SampleType *
SampleToHistogramFilter2< TSample, THistogram >
::GetInput() const
{
...
template < class TSample, class THistogram >
const typename 
SampleToHistogramFilter2< TSample, THistogram >::HistogramType *
SampleToHistogramFilter2< TSample, THistogram >
::GetOutput() const
{
...
template < class TSample, class THistogram >
typename SampleToHistogramFilter2< TSample, THistogram >::DataObjectPointer
SampleToHistogramFilter2< TSample, THistogram >
...
::GenerateData()
{
  ...
  if( autoMinimumMaximum && autoMinimumMaximum->Get() )
    ...
    if( inputSample->Size() )
      {
        itk::Statistics::Algorithm2::FindSampleBound( 
