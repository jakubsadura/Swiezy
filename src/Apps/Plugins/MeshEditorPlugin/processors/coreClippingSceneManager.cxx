...
void Core::ClippingSceneManager::ConstructRenderingTree( Core::RenderingTreeMITK::Pointer &renderingTree )
{
...
{
	this->m_RenderingTree->SetProperty(
		this->m_MarkerSetDataEntity, blTag::New( "pointsize", float(markerSize) ) );
}
